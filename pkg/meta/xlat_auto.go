...
var generatedXlatTables = map[string]XlatTable{
	...
	"if_dqblk_valid": {
		Prefix: "QIF_",
		Entries: []XlatVal{
			{Val: 1, Str: "QIF_BLIMITS"},
			{Val: 2, Str: "QIF_SPACE"},
			{Val: 4, Str: "QIF_ILIMITS"},
			{Val: 8, Str: "QIF_INODES"},
			{Val: 16, Str: "QIF_BTIME"},
			{Val: 32, Str: "QIF_ITIME"},
		},
	},
	"if_dqinfo_flags": {
		Prefix: "DQF_",
		Entries: []XlatVal{
			{Val: 1, Str: "DQF_ROOT_SQUASH"},
			{Val: 65536, Str: "DQF_SYS_FILE"},
		},
	},
	"if_dqinfo_valid": {
		Prefix: "IIF_",
		Entries: []XlatVal{
			{Val: 1, Str: "IIF_BGRACE"},
			{Val: 2, Str: "IIF_IGRACE"},
			{Val: 4, Str: "IIF_FLAGS"},
		},
	},
	"inotify_init_flags": {
	...
	"itimer_which": {
		Prefix: "ITIMER_",
		Entries: []XlatVal{
			{Val: 0, Str: "ITIMER_REAL"},
			{Val: 1, Str: "ITIMER_VIRTUAL"},
			{Val: 2, Str: "ITIMER_PROF"},
		},
	},
	"key_spec": {
		Prefix: "KEY_SPEC_",
	...
	"keyctl_commands": {
		Prefix: "KEYCTL_",
		Entries: []XlatVal{
			{Val: 1, Str: "KEYCTL_JOIN_SESSION_KEYRING"},
			{Val: 2, Str: "KEYCTL_UPDATE"},
			{Val: 3, Str: "KEYCTL_REVOKE"},
			{Val: 4, Str: "KEYCTL_CHOWN"},
			{Val: 5, Str: "KEYCTL_SETPERM"},
			{Val: 6, Str: "KEYCTL_DESCRIBE"},
			{Val: 7, Str: "KEYCTL_CLEAR"},
			{Val: 8, Str: "KEYCTL_LINK"},
			{Val: 9, Str: "KEYCTL_UNLINK"},
			{Val: 10, Str: "KEYCTL_SEARCH"},
			{Val: 11, Str: "KEYCTL_READ"},
			{Val: 12, Str: "KEYCTL_INSTANTIATE"},
			{Val: 13, Str: "KEYCTL_NEGATE"},
			{Val: 14, Str: "KEYCTL_SET_REQKEY_KEYRING"},
			{Val: 15, Str: "KEYCTL_SET_TIMEOUT"},
			{Val: 16, Str: "KEYCTL_ASSUME_AUTHORITY"},
			{Val: 17, Str: "KEYCTL_GET_SECURITY"},
			{Val: 18, Str: "KEYCTL_SESSION_TO_PARENT"},
			{Val: 19, Str: "KEYCTL_REJECT"},
			{Val: 20, Str: "KEYCTL_INSTANTIATE_IOV"},
			{Val: 21, Str: "KEYCTL_INVALIDATE"},
			{Val: 22, Str: "KEYCTL_GET_PERSISTENT"},
			{Val: 23, Str: "KEYCTL_DH_COMPUTE"},
			{Val: 24, Str: "KEYCTL_PKEY_QUERY"},
			{Val: 25, Str: "KEYCTL_PKEY_ENCRYPT"},
			{Val: 26, Str: "KEYCTL_PKEY_DECRYPT"},
			{Val: 27, Str: "KEYCTL_PKEY_SIGN"},
			{Val: 28, Str: "KEYCTL_PKEY_VERIFY"},
			{Val: 29, Str: "KEYCTL_RESTRICT_KEYRING"},
			{Val: 30, Str: "KEYCTL_MOVE"},
			{Val: 31, Str: "KEYCTL_CAPABILITIES"},
			{Val: 32, Str: "KEYCTL_WATCH_KEY"},
		},
	},
	"listmount_flags": {
		Prefix: "LISTMOUNT_",
	...
	"madvise_cmds": {
		...
		Entries: []XlatVal{
			...
			{Val: 15, Str: "MADV_NOHUGEPAGE"},
			{Val: 16, Str: "MADV_DONTDUMP"},
			{Val: 17, Str: "MADV_DODUMP"},
	...
	"mlock_flags": {
		Prefix: "MLOCK_",
		Entries: []XlatVal{
			{Val: 1, Str: "MLOCK_ONFAULT"},
		},
	},
	"mlockall_flags": {
		Prefix: "MCL_",
		Entries: []XlatVal{
			{Val: 1, Str: "MCL_CURRENT"},
			{Val: 2, Str: "MCL_FUTURE"},
			{Val: 4, Str: "MCL_ONFAULT"},
			{Val: 1, Str: "MCL_CURRENT"},
			{Val: 2, Str: "MCL_FUTURE"},
			{Val: 4, Str: "MCL_ONFAULT"},
		},
	...
	"open_resolve_flags": {
		Prefix: "RESOLVE_",
		Entries: []XlatVal{
			{Val: 1, Str: "RESOLVE_NO_XDEV"},
			{Val: 2, Str: "RESOLVE_NO_MAGICLINKS"},
			{Val: 4, Str: "RESOLVE_NO_SYMLINKS"},
	...
	"quota_formats": {
		Prefix: "QFMT_",
		Entries: []XlatVal{
			{Val: 1, Str: "QFMT_VFS_OLD"},
			{Val: 2, Str: "QFMT_VFS_V0"},
			{Val: 3, Str: "QFMT_OCFS2"},
			{Val: 4, Str: "QFMT_VFS_V1"},
			{Val: 5, Str: "QFMT_SHMEM"},
		},
	},
	"quotacmds": {
		Prefix: "Q_",
		Entries: []XlatVal{
			{Val: 256, Str: "Q_V1_QUOTAON"},
			{Val: 512, Str: "Q_V1_QUOTAOFF"},
			{Val: 768, Str: "Q_V1_GETQUOTA"},
			{Val: 1024, Str: "Q_V1_SETQUOTA"},
			{Val: 1280, Str: "Q_V1_SETUSE"},
			{Val: 1536, Str: "Q_V1_SYNC"},
			{Val: 1792, Str: "Q_SETQLIM"},
			{Val: 2048, Str: "Q_V1_GETSTATS"},
			{Val: 4096, Str: "Q_V1_RSQUASH"},
			{Val: 3328, Str: "Q_V2_GETQUOTA"},
			{Val: 3584, Str: "Q_V2_SETQUOTA"},
			{Val: 3840, Str: "Q_V2_SETUSE"},
			{Val: 2304, Str: "Q_V2_GETINFO"},
			{Val: 2560, Str: "Q_V2_SETINFO"},
			{Val: 2816, Str: "Q_V2_SETGRACE"},
			{Val: 3072, Str: "Q_V2_SETFLAGS"},
			{Val: 4352, Str: "Q_V2_GETSTATS"},
			{Val: 8388609, Str: "Q_SYNC"},
			{Val: 8388610, Str: "Q_QUOTAON"},
			{Val: 8388611, Str: "Q_QUOTAOFF"},
			{Val: 8388612, Str: "Q_GETFMT"},
			{Val: 8388613, Str: "Q_GETINFO"},
			{Val: 8388614, Str: "Q_SETINFO"},
			{Val: 8388615, Str: "Q_GETQUOTA"},
			{Val: 8388616, Str: "Q_SETQUOTA"},
			{Val: 8388617, Str: "Q_GETNEXTQUOTA"},
			{Val: 22529, Str: "Q_XQUOTAON"},
			{Val: 22530, Str: "Q_XQUOTAOFF"},
			{Val: 22531, Str: "Q_XGETQUOTA"},
			{Val: 22532, Str: "Q_XSETQLIM"},
			{Val: 22533, Str: "Q_XGETQSTAT"},
			{Val: 22534, Str: "Q_XQUOTARM"},
			{Val: 22535, Str: "Q_XQUOTASYNC"},
			{Val: 22536, Str: "Q_XGETQSTATV"},
			{Val: 22537, Str: "Q_XGETNEXTQUOTA"},
		},
	},
	"quotatypes": {
		Prefix: "",
