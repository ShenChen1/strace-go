...
func decodeBpfInsns(ctx *Context, insnsAddr uint64, cnt uint32) string {
	...
	for i := 0; i < actualCount; i++ {
		parts = append(parts, decodeSingleInsn(buf[i*8:(i+1)*8]))
	}
	res := "insns=[" + strings.Join(parts, ", ") + "]"
	if cnt > uint32(actualCount) {
		res += "..."
	}
	return res
}
...
func decodeBpfInsnCode(code uint8) string {
	...
	var classStr string
	switch class {
	case 0: classStr = "BPF_LD"
	case 1: classStr = "BPF_LDX"
	case 2: classStr = "BPF_ST"
	case 3: classStr = "BPF_STX"
	case 4: classStr = "BPF_ALU"
	case 5: classStr = "BPF_JMP"
	case 6: classStr = "BPF_JMP32"
	case 7: classStr = "BPF_ALU64"
	}
	src := code & 0x08
	var srcStr string
	if src == 0 {
...
func decodeBpfInsnMem(code uint8, classStr string) string {
	...
	size := code & 0x18
	switch size {
	case 0x00: opStr = "BPF_W"
	case 0x08: opStr = "BPF_H"
	case 0x10: opStr = "BPF_B"
	case 0x18: opStr = "BPF_DW"
	}
	mode := code & 0xe0
	var modeStr string
	switch mode {
	case 0x00: modeStr = "BPF_IMM"
	case 0x20: modeStr = "BPF_ABS"
	case 0x40: modeStr = "BPF_IND"
	case 0x60: modeStr = "BPF_MEM"
	case 0xc0: modeStr = "BPF_XADD"
	default: modeStr = fmt.Sprintf("%#x", mode)
	}
...
func decodeBpfInsnJmp(code uint8, classStr string, src uint8, srcStr string) string {
	...
	op := code & 0xf0
	switch op {
	case 0x00: opStr = "BPF_ADD"
	case 0x10: opStr = "BPF_SUB"
	case 0x20: opStr = "BPF_MUL"
	case 0x30: opStr = "BPF_DIV"
	case 0x40: opStr = "BPF_OR"
	case 0x50: opStr = "BPF_AND"
	case 0x60: opStr = "BPF_LSH"
	case 0x70: opStr = "BPF_RSH"
	case 0x80: opStr = "BPF_JA"
	case 0x90:
		if src == 0 {
			return "BPF_JMP|BPF_K|BPF_EXIT"
		}
		opStr = "BPF_JEQ"
	case 0xa0: opStr = "BPF_JGT"
	case 0xb0: opStr = "BPF_JGE"
	case 0xc0: opStr = "BPF_JSET"
	case 0xd0: opStr = "BPF_JNE"
	case 0xe0: opStr = "BPF_JSGT"
	case 0xf0: opStr = "BPF_JSGE"
	default: opStr = fmt.Sprintf("%#x", op)
	}
...
func decodeBpfInsnAlu(code uint8, classStr string, srcStr string) string {
	...
	case 0x60: opStr = "BPF_LSH"
	case 0x70: opStr = "BPF_RSH"
	case 0x80: opStr = "BPF_NEG"
	case 0x90: opStr = "BPF_MOD"
	case 0xa0: opStr = "BPF_XOR"
	case 0xb0: opStr = "BPF_MOV"
	case 0xc0: opStr = "BPF_ARSH"
	case 0xd0: opStr = "BPF_END"
	default: opStr = fmt.Sprintf("%#x", op)
	}
	return classStr + "|" + srcStr + "|" + opStr
}
