#ifndef STRACE_GO_SYSCALL_SMALL_STRUCT_EMIT_DIRECT_EVENT_V2_H
#define STRACE_GO_SYSCALL_SMALL_STRUCT_EMIT_DIRECT_EVENT_V2_H

static __always_inline void emit_small_struct_enter_word_event_v2_direct(
    u32 pid,
    u32 tid,
    u32 sys_id,
    ...
    u64 ts_ns)
{
    ...
    u32 payload_size = capture_small_struct_word_tlv_direct(
        &ptr,
        payload_offset,
        2,
        ctx->args[2],
    ...
    u64 ts_ns)
{
    ...
    emit_small_struct_enter_word_event_v2_direct(pid, tid, sys_id, ctx, ts_ns);
}
