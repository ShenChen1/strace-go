#ifndef STRACE_GO_SYSCALL_SELECT_EMIT_DIRECT_EVENT_V2_H
#define STRACE_GO_SYSCALL_SELECT_EMIT_DIRECT_EVENT_V2_H
    ...
    u64 duration)
{
    ...
    u16 flags = 0;
    u8 capture_policy = SELECT_DIRECT_CAPTURE_TIMEOUT;
    if (ret_value > 0) {
        capture_policy |= SELECT_DIRECT_CAPTURE_FDSETS;
    }
    u32 payload_size = capture_select_payloads_tlv_direct(
        &ptr,
        payload_offset,
