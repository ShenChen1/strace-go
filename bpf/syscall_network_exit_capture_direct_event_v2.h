#ifndef STRACE_GO_SYSCALL_NETWORK_EXIT_CAPTURE_DIRECT_EVENT_V2_H
#define STRACE_GO_SYSCALL_NETWORK_EXIT_CAPTURE_DIRECT_EVENT_V2_H

#include "syscall_network_capture_direct_event_v2.h"

/* Exit-side network payload capture stays separate from event submission. */
