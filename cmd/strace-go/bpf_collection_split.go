...
var bpfHandlerProgramFamilies = map[string]bpfHandlerFamily{
	...
	"enter_select_fd_path0":            bpfHandlerEnterControlFamily,
	"enter_select_fd_path1":            bpfHandlerEnterControlFamily,
	"enter_select_fd_path2":            bpfHandlerEnterControlFamily,
	"enter_select_fd_path3":            bpfHandlerEnterControlFamily,
