...
var bpfHandlerProgramFamilies = map[string]bpfHandlerFamily{
	...
	"exit_nested_fd_path0":             bpfHandlerExitFamily,
	"exit_nested_fd_path1":             bpfHandlerExitFamily,
	"exit_nested_fd_path2":             bpfHandlerExitFamily,
	"exit_nested_fd_path3":             bpfHandlerExitFamily,
