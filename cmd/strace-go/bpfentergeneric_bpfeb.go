...
type bpfEnterGenericBpfStats struct {
...
type bpfEnterGenericFdPathScratch struct {
	_             structs.HostLayout
	Name          [256]int8
	Components    [8]uint64
	Args          [6]uint64
...
type bpfEnterGenericPendingSyscall struct {
	_         structs.HostLayout
	EnterTime uint64
	Args      [6]uint64
	Pid       uint32
...
type bpfEnterGenericPendingSyscallAux struct {
	_    structs.HostLayout
	Aux0 uint32
}
...
func loadBpfEnterGeneric() (*ebpf.CollectionSpec, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("can't load bpfEnterGeneric: %w", err)
	}

	return spec, err
}

// loadBpfEnterGenericObjects loads bpfEnterGeneric and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*bpfEnterGenericObjects
//	*bpfEnterGenericPrograms
//	*bpfEnterGenericMaps
//
// See ebpf.CollectionSpec.LoadAndAssign documentation for details.
func loadBpfEnterGenericObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
	spec, err := loadBpfEnterGeneric()
	if err != nil {
		return err
	}
...
// bpfEnterGenericSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfEnterGenericSpecs struct {
	bpfEnterGenericProgramSpecs
	bpfEnterGenericMapSpecs
	bpfEnterGenericVariableSpecs
}

// bpfEnterGenericProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfEnterGenericProgramSpecs struct {
...
// bpfEnterGenericMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpfEnterGenericVariableSpecs struct {
...
// bpfEnterGenericObjects contains all objects after they have been loaded into the kernel.
//
// It can be passed to loadBpfEnterGenericObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfEnterGenericObjects struct {
	bpfEnterGenericPrograms
	bpfEnterGenericMaps
	bpfEnterGenericVariables
}

func (o *bpfEnterGenericObjects) Close() error {
	return _BpfEnterGenericClose(
		&o.bpfEnterGenericPrograms,
		&o.bpfEnterGenericMaps,
	)
}

// bpfEnterGenericMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadBpfEnterGenericObjects or ebpf.CollectionSpec.LoadAndAssign.
...
// bpfEnterGenericVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to loadBpfEnterGenericObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfEnterGenericVariables struct {
...
// bpfEnterGenericPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadBpfEnterGenericObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfEnterGenericPrograms struct {
	EnterNoPayloadGeneric *ebpf.Program `ebpf:"enter_no_payload_generic"`
	EnterTerminating      *ebpf.Program `ebpf:"enter_terminating"`
}

func (p *bpfEnterGenericPrograms) Close() error {
	return _BpfEnterGenericClose(
...
func _BpfEnterGenericClose(closers ...io.Closer) error {
...
//
//go:embed bpfentergeneric_bpfeb.o
var _BpfEnterGenericBytes []byte
