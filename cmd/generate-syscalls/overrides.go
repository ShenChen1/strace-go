...
var manualOverrides = map[string]SyscallMeta{
	...
	"fsetxattr": {Name: "fsetxattr", Args: []string{"fd", "name", "value", "size", "flags"}, ArgTypes: []string{"int", "const char *", "const void *", "size_t", "int"}},
	...
	"fgetxattr": {Name: "fgetxattr", Args: []string{"fd", "name", "value", "size"}, ArgTypes: []string{"int", "const char *", "void *", "size_t"}},
	...
	"flistxattr": {Name: "flistxattr", Args: []string{"fd", "list", "size"}, ArgTypes: []string{"int", "char *", "size_t"}},
	...
	"fremovexattr": {Name: "fremovexattr", Args: []string{"fd", "name"}, ArgTypes: []string{"int", "const char *"}},
	"get_robust_list": {Name: "get_robust_list", Args: []string{"pid", "head_ptr", "len_ptr"}, ArgTypes: []string{"int", "struct robust_list_head **", "size_t *"}},
	"set_robust_list": {Name: "set_robust_list", Args: []string{"head", "len"}, ArgTypes: []string{"struct robust_list_head *", "size_t"}},
	...
	"getpgid": {Name: "getpgid", Args: []string{"pid"}, ArgTypes: []string{"pid_t"}},
	"setpgid": {Name: "setpgid", Args: []string{"pid", "pgid"}, ArgTypes: []string{"pid_t", "pid_t"}},
	"getpriority": {Name: "getpriority", Args: []string{"which", "who"}, ArgTypes: []string{"int", "int"}},
	"setpriority": {Name: "setpriority", Args: []string{"which", "who", "prio"}, ArgTypes: []string{"int", "int", "int"}},
	"settimeofday": {Name: "settimeofday", Args: []string{"tv", "tz"}, ArgTypes: []string{"const struct timeval *", "const struct timezone *"}},
	"waitid": {Name: "waitid", Args: []string{"which", "upid", "infop", "options", "ru"}, ArgTypes: []string{"int", "pid_t", "struct siginfo *", "int", "struct rusage *"}},
	...
	"futex_wait": {Name: "futex_wait", Args: []string{"uaddr", "val", "mask", "flags", "timeout", "clockid"}, ArgTypes: []string{"void *", "unsigned long", "unsigned long", "unsigned int", "struct __kernel_timespec *", "clockid_t"}},
	...
	"pidfd_open":        {Name: "pidfd_open", Args: []string{"pid", "flags"}, ArgTypes: []string{"pid_t", "unsigned int"}},
	...
	"cachestat":         {Name: "cachestat", Args: []string{"fd", "cstat_range", "cstat", "flags"}, ArgTypes: []string{"unsigned int", "struct cachestat_range *", "struct cachestat *", "unsigned int"}},
}
